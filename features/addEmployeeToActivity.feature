...
Feature: Add Employee to Project
    ...
    Scenario: Add employee to project activity
        ...
        And an activity with name "design" exists
        When the user "nico" adds the employee "huba" to the activity "design"
        Then the employee "huba" is added to the activity "design"
