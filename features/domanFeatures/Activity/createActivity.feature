...
Feature: Creating an activity
  ...
  Scenario: Fail to create an activity without a project
    ...
    Then I should get an error "Project with ID 'null' not found. Cannot create activity."
  ...
  Scenario: Fail to create an activity which already exists
    Given a project "ProjectA-001" exists
    When I create an activity "Design" with budgeted time 20.0, start week 10, start year 2025, end week 20, end year 2025 for "ProjectA-001"
    And I try to create an activity "Design" with budgeted time 2.0
    Then I should get an error "Activity with name 'Design' already exists in project. Cannot create activity."

  Scenario: Fail to create an activity with negative budgeted time
    Given a project "ProjectA-001" exists
    And I try to create an activity "Design" with budgeted time -5.0
